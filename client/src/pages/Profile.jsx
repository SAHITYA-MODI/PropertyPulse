  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <Link
          to="/create-listing"
          className="bg-green-700 text-center uppercase text-white p-3 rounded-lg hover:opacity-95"
        >
          Create Listing
        </Link>
      </form>
      ...
      {userListings && userListings.length > 0 && (
        <div className="flex flex-col gap-4">
          ...
          {userListings.map((listings) => {
            <div
              key={listings._id}
              className="border rounded-lg flex justify-between items-center gap-0"
            >
              ...
              <Link
                ...
                className="text-slate-700 hover:underline font-semibold truncate flex-1"
              >
                {listings.name}
              </Link>
